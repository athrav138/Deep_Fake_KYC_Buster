...
import { Shield, Github, Linkedin, Heart, Globe, Mail, Users, HelpCircle } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm opacity-60">
              <li><Link to="/community" className="hover:text-emerald-500 transition-colors flex items-center gap-2 px-1"><Users className="w-3 h-3"/> Community</Link></li>
              <li><Link to="/support" className="hover:text-emerald-500 transition-colors flex items-center gap-2 px-1"><HelpCircle className="w-3 h-3"/> Support Hub</Link></li>
              <li><a href="#" className="hover:text-emerald-500 transition-colors px-1">API Documentation</a></li>
              <li><a href="#" className="hover:text-emerald-500 transition-colors px-1">Security</a></li>
            </ul>
          </div>
