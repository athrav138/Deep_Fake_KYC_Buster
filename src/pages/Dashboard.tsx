...
import { Shield, CheckCircle2, AlertCircle, Clock, ArrowRight, Fingerprint, Camera, Mic, Video, ShieldX, ShieldCheck, Calendar, Users, TrendingUp } from 'lucide-react';
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div 
              ...
              className="bg-emerald-500/10 border border-emerald-500/20 rounded-3xl p-6 cursor-pointer hover:bg-emerald-500/20 transition-all group overflow-hidden relative"
            >
              <div className="absolute top-0 right-0 p-4 opacity-5 group-hover:opacity-10 transition-opacity">
                <Users className="w-24 h-24" />
              </div>
              <Users className="w-8 h-8 text-emerald-400 mb-4 group-hover:scale-110 transition-transform" />
              <h3 className="font-bold mb-2">Community Connect</h3>
              <p className="text-sm opacity-50">Join the discussion, share experiences, and see live security trends.</p>
            ...
            <div 
              ...
              className="bg-app-card border border-app-border rounded-3xl p-6 cursor-pointer hover:bg-app-card/80 transition-all group lg:col-span-1"
            >
              ...
              <p className="text-sm opacity-50">Need help? Connect with our security team for one-on-one assistance.</p>
            </div>
